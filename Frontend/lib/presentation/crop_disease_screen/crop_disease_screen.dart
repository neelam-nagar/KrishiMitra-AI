    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          confidenceValue =
              double.tryParse(data['prediction']['confidence'].toString()) ??
                  0;
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    Color.lerp(primaryGreen, lightGreen, t)!,
                    Color.lerp(lightGreen, primaryGreen, t)!,
                  ],
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight,
                ),
                ...
                boxShadow: [
                  BoxShadow(
                    color: midGreen.withOpacity(0.3 + t * 0.2),
                    blurRadius: 14 + t * 8,
                    offset: const Offset(0, 6),
                  ),
                ],
      ...
      builder: (_, __) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                Color.lerp(primaryGreen, const Color(0xFF1A5C1A), t)!,
                Color.lerp(const Color(0xFF388E3C), lightGreen, t)!,
              ],
              begin: Alignment.topLeft,
              end: Alignment.bottomRight,
            ),
  ...
  Widget _buildImagePicker() {
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: AnimatedBuilder(
            ...
            builder: (_, child) => Transform.scale(
              scale: _webImage == null ? _pulseAnim.value : 1.0,
              child: child,
            ),
            child: Container(
              height: 300,
        ...
        const SizedBox(height: 12),
        // Camera + Gallery row buttons
        Row(
          children: [
            Expanded(
              child: _miniSourceButton(
                icon: Icons.camera_alt_rounded,
                label: 'कैमरा',
      ...
      children: [
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: const Row(
              children: [
                Icon(Icons.check_circle, color: lightGreen, size: 14),
                SizedBox(width: 6),
                Text(
                  'फोटो तैयार है',
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(icon, color: midGreen, size: 20),
      ...
      child: ElevatedButton(
        ...
        child: Ink(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: midGreen.withOpacity(0.4),
                blurRadius: 16,
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: (isHealthy ? midGreen : Colors.orange)
                      .withOpacity(0.35),
                  blurRadius: 18,
                  offset: const Offset(0, 8),
                ),
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      isHealthy ? 'फसल स्वस्थ है!' : 'रोग पाया गया',
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 18,
                        fontWeight: FontWeight.w800,
        ...
        children: [
          Row(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.analytics_rounded, color: midGreen, size: 20),
                  const SizedBox(width: 8),
                  const Text(
                    'AI सटीकता',
                    style: TextStyle(
                ...
                builder: (_, __) {
                  ...
                  return Text(
                    ...
                    style: TextStyle(
                      fontSize: 22,
                      fontWeight: FontWeight.w800,
                      color: _confidenceColor(confidenceValue),
                    ),
                  );
                },
              ),
              ...
              builder: (_, __) {
                return LinearProgressIndicator(
                  ...
                  valueColor: AlwaysStoppedAnimation<Color>(
                    _confidenceColor(confidenceValue),
                  ),
                );
              },
            ),
              ...
              child: Row(
                children: [
                  Container(
                    padding: const EdgeInsets.all(8),
                    decoration: BoxDecoration(
                      color: midGreen.withOpacity(0.1),
                      borderRadius: BorderRadius.circular(10),
                    ),
                    child:
                        const Icon(Icons.phone, color: midGreen, size: 16),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
